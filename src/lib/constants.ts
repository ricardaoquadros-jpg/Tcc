...
export const backendTechnologies: Technology[] = [
  ...
  },
  {
    name: 'SAP ERP',
    icon: SapErpIcon,
    description: 'Software de planejamento de recursos empresariais (ERP) líder de mercado para gerenciamento de operações de negócios.',
    type: 'Plataforma',
    detailedDescription: 'SAP ERP é um software que integra as principais funções de negócios de uma organização. É a espinha dorsal de muitas das maiores empresas do mundo, gerenciando finanças, logística, recursos humanos e muito mais. O desenvolvimento no backend geralmente envolve a linguagem ABAP, específica da SAP.',
    examples: 'A grande maioria das empresas da Fortune 500, como a Dell e a TKE.',
    difficulty: 9.8,
    popularity: 8.5,
  },
  {
    name: 'Oracle DB',
    icon: OracleIcon,
    description: 'Um sistema de gerenciamento de banco de dados relacional de múltiplos modelos, líder em ambientes corporativos.',
    type: 'Plataforma',
    detailedDescription: 'O Oracle Database é um dos RDBMS mais poderosos e utilizados no mundo corporativo. É conhecido por sua escalabilidade, robustez e vasto conjunto de recursos para processamento de transações, business intelligence e análise de dados. É uma escolha comum para aplicações críticas de missão.',
    examples: 'Grandes bancos, empresas de telecomunicações, e setores governamentais.',
    difficulty: 8.2,
    popularity: 8.8,
  },
  {
    name: 'SQL Server',
    icon: SqlServerIcon,
    description: 'Um sistema de gerenciamento de banco de dados relacional desenvolvido pela Microsoft.',
    type: 'Plataforma',
    detailedDescription: 'O Microsoft SQL Server é um RDBMS projetado para o ecossistema Windows (embora agora também suporte Linux). É amplamente utilizado em ambientes corporativos, especialmente por empresas que já utilizam outras tecnologias Microsoft, como .NET. Oferece excelente integração com outras ferramentas da Microsoft, como o Power BI.',
    examples: 'Dell, e muitas empresas que utilizam a pilha de tecnologia da Microsoft.',
    difficulty: 7.5,
    popularity: 9.0,
  },
  {
    name: 'Power BI',
    icon: PowerBiIcon,
    description: 'Uma ferramenta de business intelligence que fornece visualizações interativas com recursos de BI de autoatendimento.',
    type: 'Ferramenta',
    detailedDescription: 'Power BI é uma coleção de serviços de software, aplicativos e conectores que trabalham juntos para transformar suas fontes de dados não relacionadas em insights coerentes, visualmente imersivos e interativos. Os dados podem ser de um banco de dados SQL Server, uma planilha do Excel ou de fontes de nuvem e locais.',
    examples: 'Utilizado por analistas de negócios e cientistas de dados em empresas como a TKE e a Dell para criar dashboards e relatórios.',
    difficulty: 6.0,
    popularity: 9.3,
  },
  {
    name: 'Tableau',
    icon: TableauIcon,
    description: 'Uma plataforma líder de análise visual que transforma a maneira como usamos os dados para resolver problemas.',
    type: 'Ferramenta',
    detailedDescription: 'Tableau é uma ferramenta de software de visualização de dados focada em business intelligence. Ela permite a criação de gráficos interativos e compartilháveis, dashboards e relatórios a partir de uma ampla variedade de fontes de dados. É amplamente elogiado por sua interface de arrastar e soltar amigável.',
    examples: 'Verizon, Charles Schwab, e muitas empresas que precisam de análise de dados poderosa.',
    difficulty: 6.5,
    popularity: 9.1,
  },
];
